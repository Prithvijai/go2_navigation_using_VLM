...
: ${AMENT_CURRENT_PREFIX:="/media/saitama/Games1/Documents_ubuntu/perception_project/go2_ros2_nav/install/gemini_api"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gemini_api/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gemini_api/environment/path.sh"
